...
class WasherDryerDeviceBase extends HomeConnectDevice_1.default {
    async createWasherFlowCard() {
        ...
        await this.setProgramAutoComplete(flowCard, Object.values(Options_1.WasherProgram));
    }
    async createDryerFlowCard() {
        ...
        await this.setProgramAutoComplete(flowCard, Object.values(Options_1.DryerProgram));
    }
